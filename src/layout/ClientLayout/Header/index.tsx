                ...
                <div className="flex justify-between items-center py-3">
                    <div className="flex justify-center">
                        ...
                        <div className="ml-5 w-64">
                            <div className="border rounded-3xl flex w-full">
                                ...
                                <input type="text" className="block flex-auto py-1.5 pl-1 pr-2.5 focus:outline-none rounded-3xl w-10" placeholder="Search" />
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="flex space-x-4">
                            <a href="#" className="text-sm font-bold text-gray-500 js-sign-in-btn">
                                Đăng nhập
                            </a>
