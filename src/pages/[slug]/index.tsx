...
import { faFont, faHeartCircleMinus, faHeartCirclePlus} from '@fortawesome/free-solid-svg-icons'
...
const Content = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            commentBoxRect?.top >= headerRect?.bottom ? setIsShowAvatar(false) : setIsShowAvatar(true);
        };
                    ...
                    <div className="container mx-auto max-w-screen-xl">
                        <div className="grid grid-cols-1 gap-2 sm:grid-cols-12">
                            <div className="sm:col-span-1 text-center">
                                <div id="content-action" className={`${isSticky ? 'sticky' : ''} top-[115px]`}>
                                    {isShowAvatar && <div className="mt-5" onMouseEnter={() => setShowPopover(true)} onMouseLeave={() => setShowPopover(false)}>
                                        <Popover show={showPopover} position="right" target={
                                            <>
                                                <div className="flex justify-center cursor-pointer">
                                                    <Image src="/images/avatar-generations_prsz.jpeg" width={32} height={32} sizes="100vw" alt="your-image-alt" className="w-12 h-12 rounded-full cursor-pointer"/>
                                                </div>
                                            </>
                                        }>
                                            <UserElement />
                                    ...
                                    <div className="mt-5">
                                        <button className="text-slate-400">
                                            <FontAwesomeIcon className="w-5 h-5" icon={faHeartCirclePlus} />
                                        </button>
                                        <p className="text-base text-slate-400 py-1">+24</p>
                                        <button className=" text-slate-400">
                                            <FontAwesomeIcon className="w-5 h-5" icon={faHeartCircleMinus} />
                                        </button>
                                    </div>
                                    <div className="mt-5">
                                        <Tooltip content="Bookmark bài viết này" >
                                            <button className="text-slate-400">
                                                <BookmarkPlus width={24} height={24} />
                                            </button>
                                        </Tooltip>
                                    </div>
                                    <div className="mt-5">
                                    ...
                                    <div className="mt-5">
                                        <Tooltip content="Share on Twitter">
                                            <button className=" text-slate-400">
                                                <FontAwesomeIcon className="w-6 h-6" icon={faTwitterSquare} />
                                            </button>
                                        </Tooltip>
                                    </div>
                                </div>
                            ...
                            <section className="col-span-1 sm:col-span-7">
                                <div className="grid grid-cols-1 gap-4">
                                    <div className="p-4">
                                        <header className="grid sm:grid-cols-2 items-center">
                                            <div className="col-span-1">
                                                <div className="flex items-center gap-4">
                                                    <Link href="/profile/@hongdung">
                                                        <Image src="/images/avatar-generations_prsz.jpeg" width={32} height={32} sizes="100vw" alt="your-image-alt" className="w-12 h-12 rounded-full" />
                                                    </Link>
                                                    <div>
                                                        <div className="flex items-center mb-1">
                                                            <Link href="/profile/@hongdung" className="text-lg font-medium text-blue-600 hover:text-blue-700">Guodong (Troy) Zhao</Link>
                                                            <span className="text-sm text-slate-500 ml-2">@hongdung</span>
                                                        </div>
                                                        <div className="flex items-center">
                                                            <StatsItem itemShow={['posts', 'follower']} />
                                                            <button className="flex items-center h-5 leading-5 text-sm px-3 py-1 bg-sky-500 hover:bg-sky-600 text-white rounded-full">Đang theo dõi</button>
                                                        </div>

                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-span-1 justify-end items-center text-right">
                                                <span className="text-sm text-slate-500 mb-1 block">11/3/2015, 12:48 AM - 4 phút đọc</span>
                                                <StatsItem itemShow={['views', 'comments', 'bookmark']} className="justify-end" />
                                            </div>
                                        </header>
                                        <section id="content">
